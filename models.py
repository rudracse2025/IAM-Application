...
class User(UserMixin, db.Model):
    ...
    preferences = db.Column(JSONType, nullable=False, default=dict)
...
class Provisioning(db.Model):
    ...
    deployment_details = db.Column(JSONType, nullable=False, default=dict)
    resource_allocation = db.Column(JSONType, nullable=False, default=dict)
...
class AuditLog(db.Model):
    ...
    audit_metadata = db.Column(JSONType, nullable=False, default=dict)
    created_at = db.Column(db.DateTime, nullable=False, default=datetime.utcnow, index=True)
...
class RequestTemplate(db.Model):
    ...
    template_data = db.Column(JSONType, nullable=False, default=dict)
    is_active = db.Column(db.Boolean, nullable=False, default=True)
    created_at = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)
    updated_at = db.Column(db.DateTime, nullable=False, default=datetime.utcnow, onupdate=datetime.utcnow)
...
class ApprovalRule(db.Model):
    ...
    name = db.Column(db.String(255), nullable=False)
    domain = db.Column(db.String(255), nullable=False, index=True)
    conditions = db.Column(JSONType, nullable=False, default=dict)
    approver_roles = db.Column(JSONType, nullable=False, default=list)
    is_active = db.Column(db.Boolean, nullable=False, default=True)
    created_at = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)
    updated_at = db.Column(db.DateTime, nullable=False, default=datetime.utcnow, onupdate=datetime.utcnow)
